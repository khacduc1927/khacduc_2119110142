        ...
        <div className='sc-wrapper py-5'>
          <div className='product-s bg-white grid'>
            <div className='product-s-img'>
              <div className='img-preview py-5'>
                <div className='img-preview-zoom'>
                  <img src={singleProduct?.hinhAnh} alt={singleProduct?.tenSanPham} className="img-cover" />
                </div>
            ...
            <div className='product-s-details py-5'>
              ...
              <p className='description fs-14'>{singleProduct?.moTaNgan}</p>
              ...
              <div className='price flex align-center'>
                <span className='discounted-price fs-20 fw-7'>
                  {
                    (singleProduct?.giaBanKhuyenMai)
                  } VNĐ
                </span>
                <span className='actual-price text-dark mx-3'>{singleProduct?.giaBan} VNĐ</span>
                <span className='discounted-percent text-primary fs-12'>{(singleProduct?.giaBanKhuyenMai / singleProduct?.giaBan) * 100}%</span>
              </div>
            ...
            <p className='title fw-6 fs-16 px-3 py-1'>{singleProduct?.moTaChiTiet}</p>
          </div>
        </div>
      </div>
    </main>
